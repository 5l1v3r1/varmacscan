...
clear
echo ""
echo -e "$txtrst /varmacscan-K1-2-2017-8-3.sh"
echo -e "$yel              ***********************************************"
...
echo -e "$info  pixiewps1.2. This allows the user to quickly check ALL WPS enabled"
...
sed -i 's/No             /No   UNK       /g' /tmp/wash01.txt
sleep 3
sed -i 's/Yes            /Yes  UNK       /g' /tmp/wash01.txt
sleep 3

			fi

cat < /tmp/wash01.txt | awk -F' ' '{ if(($5 == "No") || ($5 == "Yes || $5 == "UNK" )) {print $1 " " $2 " " substr($0, index($0,$6))}}' > /tmp/wash01a.txt
sleep 2
...
cat < /tmp/wash01.txt | awk -F' ' '{ if(($5 == "No") || ($5 == "No" || $5 == "UNK" )) {print $1 " " $2 " " substr($0, index($0,$6))}}' > /tmp/wash01a.txt
...
cat < /tmp/wash01.txt | awk -F' ' '{ if(($5 == "No") || ($5 == "No" || $5 == "UNK")) {print $1 " " $2 " " substr($0, index($0,$6))}}' > /tmp/wash02.txt
...
cat < /tmp/wash01.txt | awk -F' ' '{ if(($5 == "No") || ($5 == "Yes" || $5 == "UNK")) {print $1 " " $2 " " substr($0, index($0,$6))}}' > /tmp/wash02.txt
